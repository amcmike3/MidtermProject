...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `img_url` VARCHAR(200) NOT NULL DEFAULT 'https://img1.picmix.com/output/stamp/normal/9/2/9/0/180929_2e51a.png',
...
START TRANSACTION;
USE `open_officedb`;
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `role`, `email`, `img_url`, `description`) VALUES (1, 'openadmin', 'openadmin', 1, 'Johnny', 'Doughboy', 1, 'blah@blah.com', 'https://i.redd.it/tye3sd6w7it51.jpg', 'look at me i\'m pretty');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `role`, `email`, `img_url`, `description`) VALUES (2, 'hair24', 'hair24', 1, 'Harry', 'Smith', 0, 'hair24@gmail.com', 'https://images.unsplash.com/photo-1555583743-991174c11425?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8aGFycnklMjBndXl8ZW58MHx8MHx8&auto=format&fit=crop&w=400&q=60', 'I have a lot of hair its part of my identity');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `role`, `email`, `img_url`, `description`) VALUES (3, 'finger32', 'finger32', 1, 'Fiona', 'Thieking', 0, 'finger32@gmail.com', 'https://plus.unsplash.com/premium_photo-1671717724812-c264ec0e8fce?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8ZmluZ2Vyc3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=400&q=60', 'I was born with extra fingers and missing toes');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `role`, `email`, `img_url`, `description`) VALUES (4, 'cool_man007', 'cool_man007', 1, 'James', 'Bond', 0, 'cool_man007@gmail.com', 'https://images.unsplash.com/photo-1495576596703-e0063a132b6e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8c3B5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=400&q=60', 'I like my drinks shaken not stirred');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `role`, `email`, `img_url`, `description`) VALUES (5, 'soap-sock88', 'soap-sock88', 1, 'John', 'Douglas', 0, 'soap-sock88@gmail.com', 'https://images.unsplash.com/photo-1597843797221-e34b4a320b97?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8c29ja3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=400&q=60', 'I was disciplinged with a soap sock when I was a kid');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `role`, `email`, `img_url`, `description`) VALUES (6, 'supreme_garbage', 'supreme_garbage', 1, 'Terry', 'Paine', 0, 'supreme_garbage@gmail.com', 'https://images.unsplash.com/flagged/photo-1572213426852-0e4ed8f41ff6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8d2FzdGV8ZW58MHx8MHx8&auto=format&fit=crop&w=400&q=60', 'I work for WM');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `role`, `email`, `img_url`, `description`) VALUES (7, 'surfaceCleaner', 'surfaceCleaner', 1, 'Shawni', 'Tawni', 0, 'surfaceCleaner@gmail.com', 'https://images.unsplash.com/photo-1580256081112-e49377338b7f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8Y2xlYW5lcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=400&q=60', 'I want to start my own cleaning business but I am crippled by insecurity');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `role`, `email`, `img_url`, `description`) VALUES (8, 'guy1234', 'guy1234', 1, 'Tawni', 'Shawni', 0, 'guy1234@gmail.com', 'https://images.unsplash.com/photo-1564564244660-5d73c057f2d2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8Z3V5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=400&q=60', 'Just a normal dude');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `role`, `email`, `img_url`, `description`) VALUES (9, 'girl1929', 'girl1929', 1, 'Tony', 'Ale', 0, 'girl1929@gmail.com', 'https://images.unsplash.com/photo-1602233158242-3ba0ac4d2167?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Z2lybHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=400&q=60', 'Just your average Girl');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `first_name`, `last_name`, `role`, `email`, `img_url`, `description`) VALUES (10, 'username_blank', 'username_blank', 1, 'Barry', 'Scary', 1, 'username_blank@gmail.com', 'https://images.unsplash.com/photo-1579389083078-4e7018379f7e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8YWRtaW58ZW58MHx8MHx8&auto=format&fit=crop&w=400&q=60', 'I am all business which is why I was promoted to admin of this website');
